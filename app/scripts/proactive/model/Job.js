define(
    ...
    return SchemaModel.extend({
        schema: {
            ...
            "Local Variables": {type: 'List', itemType: 'Object', fieldAttrs: {'placeholder': 'variables->variable', "data-help":"On the job level you can define variables that are available in all tasks. Then anywhere in your task you can reference to it."}, itemToString: Utils.inlineName, subSchema: {
            ...
            "User Space Url": {type: "Text", fieldAttrs: {"data-tab": "Data Management", 'placeholder': 'userSpace->@attributes->url', "data-help":"A User Space which is a personal user data storage. Usually you set this url if you want to use your own data space server, not the one that is included into the scheduler."}},
            "Global Space Url": {type: "Text", fieldAttrs: {'placeholder': 'globalSpace->@attributes->url', "data-help":"A Global Space where anyone can read/write files. Usually you set this url if you want to use your own data space server, not the one that is included into the scheduler."}},
            "Input Space Url": {type: "Text", fieldAttrs: {'placeholder': 'inputSpace->@attributes->url', "data-help":"A Data Space where anyone can read files. Usually you set this url if you want to use your own data space server, not the one that is included into the scheduler."}},
            "Output Space Url": {type: "Text", fieldAttrs: {'placeholder': 'outputSpace->@attributes->url', "data-help":"A Data Space where anyone can write files. Usually you set this url if you want to use your own data space server, not the one that is included into the scheduler."}},
