        ...
        var Task = SchemaModel.extend({
            schema: {
                ...
                "Variables": {
                    ...
                    "Description": { fieldAttrs: {'placeholder': '@attributes->description'}, type: 'TextArea', editorClass: 'popup-input-text-field textareavalues', editorAttrs: {'rows': '1'} },
                    "Group": { fieldAttrs: { 'placeholder': '@attributes->group', 'title': 'The variable can be assigned to a group. Variables of the same group will appear together in the workflow submission form.' }, type: 'TextArea', editorClass: 'popup-input-text-field textareavalues', editorAttrs: {'rows': '1'} },
