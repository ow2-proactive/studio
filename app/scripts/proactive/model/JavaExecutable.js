define(
    ...
    return SchemaModel.extend({
        schema: {
            "Class": {type: "Text", fieldAttrs: {'placeholder': '@attributes->class', "data-help":'A java class extending the Scheduler API. It can be in a JAR attached to additional classpath.'}},
