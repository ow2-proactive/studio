define(
    ...
    return SchemaModel.extend({
        schema: {
            ...
            "Engine": {type: 'Select', options: ["javascript", "groovy", "ruby", "python", "bash", "cmd"], fieldAttrs: {'placeholder': 'code->@attributes->language', "data-help":"JSR-223 Java Scripting Engine"}},
