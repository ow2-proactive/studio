define(
    ...
    function (Backbone, SchemaModel, Script) {
        ...
        schema: {
            "Command": {type: "Text", fieldAttrs: {'placeholder': 'staticCommand->@attributes->value', "data-help":'A native executable to run. Must not contain parameters. E.g. for command \"/bin/bash echo test\" only /bin/bash should be specified here. Everything else should be set as arguments.'}},
