    ...
    return ViewWithProperties.extend({
        ...
        initialize: function() {
                if (!this.model) {
                    ...
                    this.model.set("ScriptExecutable", {
                        "ScriptType": "ScriptCode",
                        "ScriptCode": {
                            "Code": "println variables.get(\"PA_TASK_NAME\")",
                            "Language": "groovy"
                        }
                    });
            ...
            */
                    ...
                    case "Podman":
                        ...
                        this.model.get('Fork Environment')['Environment Script'] = {
                            ...
                            ScriptCode: {
                                ...
                                Language: prefixCommandLanguage
                            }
                        };
                        break;
                }
            ...
            showControlFlowScript: function(label, evn) {
                ...
                if (!evn.stopBubble) {
                    evn.stopBubble = true;
                    evn.isPropagationStopped = function() {
                        return true;
                    }
                } else {
                    return;
                ...
                var modelView = new ViewWithProperties({
                    el: labelElem,
                    model: controlFlow.model
                })
                modelView.render();
                modelView.$el.click();
            },
            endpointsParams: function(type) {
                ...
                if (type == 'if') {
                    ...
                    var endpointTypes = {
                        'dependency': {
                            color: '#666',
                            anchorSource: 'BottomCenter',
                            anchorTarget: 'TopCenter',
                            scope: "dependency",
                            overlays: [
                                ["Arrow", {
                                    location: 0.7
                        ...
                        'replicate': {
                            color: 'rgba(229,219,61,0.5)',
                            anchorSource: [0.8, 1, 0, 1],
                            anchorTarget: [0.8, 0],
                            scope: "replicate",
                            overlays: [
                                ["Arrow", {
            ...
            addSourceEndPoint: function(type) {
                ...
                return jsPlumb.addEndpoint(that.$el, sourceEndpoint, {
                    'anchor': params.anchorSource
                });
            },
            addTargetEndPoint: function(type) {
                ...
                return jsPlumb.addEndpoint(that.$el, targetEndpoint, {
                    'anchor': params.anchorTarget
                });
            },
            ...
            render: function() {
                ...
                this.$el.find("#called-icon-a").on("click", function() {
                    that.generateCalledWorkflowModal(that.$el);
                    //show up the modal
            ...
            getTaskReferencingScriptsInModel: function() {
                ...
                if (JSON.stringify(this.model.get("Fork Environment")) != "{}") {
                    if (this.model.get("Fork Environment").hasOwnProperty("Environment Script")) {
                        ...
                        if (this.model.get("Fork Environment").get("Environment Script") && this.model.get("Fork Environment").get("Environment Script").get("ScriptType") === "ScriptFile" && this.model.get("Fork Environment").get("Environment Script").get("ScriptFile")) {
            ...
            generateCalledWorkflowModal: function(element) {
                ...
                for (var key of Object.keys(currentTaskVariables)) {
                    ...
                    var hrefEyeIcon;
                    var variablePathValue = "<td width='20px'>" + currentVariable.Value + "</td>";
                ...
                $(".called-catalogobject-button").click(function(event) {
                    ...
                    if (matches && matches.length > 1) {
                        ...
                        if (params[3]) {
                            studioApp.views.catalogGetView.setObjectNameFilter(params[3]); //filterObjectName
                        }
                    }
                    ...
                    $("#catalog-get-browse-button").click(function(e) {
                        ...
                        that.updateVariablesCallingWorkflowsInModel(currentTaskName, parentVariableName, parentVariableValue, newVariableValue);
                        ...
                        var selectedObjectKind = that.getObjectKind(newBucketName, newObjectName);
            ...
            getObjectKind: function(bucketName, objectName) {
                var objectKind = null;
                $.ajax({
                    'async': false,
                    'type': "GET",
            ...
            getCalledObjectDetails: function(variableValue) {
            ...
            getTaskVariablesCallingWorkflowsInModel: function(element) {
                var taskVariables = {};
                var studioApp = require('StudioApp');
                var tasks = studioApp.models.jobModel.tasks;
                var tasksArray = [];
